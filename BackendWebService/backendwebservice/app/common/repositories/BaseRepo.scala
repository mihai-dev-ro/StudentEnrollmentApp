...
//trait BaseRepo[ModelId <: BaseId[Int], Model <: WithId[Int, ModelId]] {
//  def getAll[Model]: Future[Seq[Model]]
//  def getById[Model]: Future[Option[Model]]
//}

trait BaseRepo[ModelId <: BaseId[Long],
  Model <: WithId[Long, ModelId],
  ModelTable <: IdTable[ModelId, Model]] {
...
abstract class IdTable[Id <: BaseId[Int], Entity <: WithId[Int, Id]]
  ...
  def this(tag: Tag, tableName: String)(
    implicit mapping: BaseColumnType[Id]) = this(tag, None, tableName)
